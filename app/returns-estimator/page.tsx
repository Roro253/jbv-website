...
import { loadInvestmentData, NormalizedData } from './lib/dataAdapter';
...
export default function ReturnsEstimatorPage(){
  ...
  const [kpis, setKpis] = useState<NormalizedData['kpis']>();
  useEffect(() => {
    loadInvestmentData().then(d => setKpis(d.kpis));
  }, []);
    ...
    <div className="container-6xl py-6 space-y-6">
      {!accepted && (
        <div className="fixed inset-0 z-50 bg-black/80 flex items-center justify-center">
          <div className="bg-white text-black border rounded-2xl p-6 max-w-lg mx-4 space-y-4 text-sm">
